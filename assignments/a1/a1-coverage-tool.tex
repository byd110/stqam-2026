...
this is using the Python disassembler, in the \texttt{dis} module.

My template for \texttt{populate\_executable\_lines()} requests the
function bytecode by using \texttt{dis} to create a \texttt{Bytecode} object for each
...
most recently seen line number for it. (There is also an API call that will compute this dict,
