...
class GrammarFuzzer(Fuzzer):
    ...
    def descendants(self, tree:DerivationTree, parent:DerivationTree) -> List[DerivationTree]:
        """ Returns a list of triples `(d, parent, index)`, one for each descendant `d` of the root in `tree`.
        `parent` is a reference containing the parent of `d`, and `index` is the index of `d` in `parent`'s children.
        """
        return []
