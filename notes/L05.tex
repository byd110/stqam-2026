...
But, who's to say that the output is correct or incorrect? This is the oracle problem. See~\cite{barr15:_oracl_probl_softw_testin} for an exhaustive survey of the research literature on the oracle problem as of 2015.
...
As a human oracle, you are using the function name as the specification, combined with your human experience. Maybe you also consider the function documentation, if it exists.
...
There's what seems to me like the eternal dream of test suite reduction,
for which there are no general-purpose solutions that I'm aware of.
Also test case reduction, which we'll talk about in the fuzzing module.
