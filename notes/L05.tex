...
what should happen if there are no solutions? There's also floating-point issues e.g. with comparisons.
...
whether it is correct or not. It comes down to whether the output
