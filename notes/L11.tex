...
\lecture{11 --- February 9, 2026}{Winter 2026}{Patrick Lam}{version 0}
...
at our disposal, but we can use plain old \texttt{RandomFuzzer} to find the failure.
...
it's looking for two characters, but the characters don't have to be
in the same half.
